// 1. Add this line near the very top of your Program.cs if it isn't there
using System.Text;
using Demo;
...
app.UseDefaultFiles(); // Tells .NET to look for an index.html file
app.UseStaticFiles();  // Allows .NET to host images, HTML, and CSS files
